<div id="modalEditar" class="modal-editar justify-center hidden">
    <div class="w-[600px] h-[720px] self-center bg-white p-4">
        ...
        <form class="flex flex-col mt-4" method="post" action="/handle_db/admin_handle_db/CRUD_MAESTRO/editar_maestro.php">
            <input id='idUsuario' hidden name="id_usuario">
            <div class="flex flex-col mb-2">
                <label class="text-lg font-semibold">Correo Electronico</label>
                <input id="emailUsuario" type="email" name="email" class="ring-1 ring-[#c2c5cd]" disabled>
            </div>
            <div class="flex flex-col py-4  ">
                <label class="text-lg font-semibold">Nombre(s)</label>
                <input id="nombreUsuario" type="text" name="nombre_usuario" class="ring-1 ring-[#c2c5cd]">
                </input>
            </div>
            <div class="flex flex-col py-4  ">
                <label class="text-lg font-semibold">Apellido</label>
                <input id="apellidoUsuario" type="text" name="apellido" class="ring-1 ring-[#c2c5cd]">
                </input>
            </div>
            <div class="flex flex-col pb-4 border-2 border-white border-b-[#c2c5cd] ">
                <label class="text-lg font-semibold">Direccion</label>
                <input id="direccionUsuario" type="text" name="direccion" class="ring-1 ring-[#c2c5cd]">
            </div>
            <div class="flex flex-col pb-4 border-2 border-white border-b-[#c2c5cd] ">
                <label class="text-lg font-semibold">Fecha de Nacimineto</label>
                <input id="fechaNacimiento" type="date" name="fecha_nacimiento" class="ring-1 ring-[#c2c5cd]">
            </div>
            <div class="flex flex-col pb-4 border-2 border-white border-b-[#c2c5cd] ">
                <label class="text-lg font-semibold">Materia Asignada</label>
                <select id="claseAsignada" name="new_id_materia" class="ring-1 ring-[#c2c5cd]">
                    <?php
