<div id="modalNuevo" class="modal-nuevo justify-center hidden">
    <div class="w-[600px] h-[720px] self-center bg-white p-4">
        <h2 class="font-semibold text-4xl p-6  border-2 border-white border-b-[#c2c5cd]">Ingresar Alumno</h2>
        <form class="flex flex-col mt-4" method="post" action="/handle_db/admin_handle_db/CRUD_ALUMNOS/crear_alumno.php">
        <div class="flex flex-col mb-2">
                <label class="text-lg font-semibold">ID</label>
                <input type="text" name="matricula" class="ring-1 ring-[#c2c5cd]">
            </div>
            <div class="flex flex-col mb-2">
                <label class="text-lg font-semibold">Correo Electronico</label>
                <input type="email" name="email" class="ring-1 ring-[#c2c5cd]">
            </div>
